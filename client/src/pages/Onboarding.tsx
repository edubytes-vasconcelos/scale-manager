...
type OnboardingView = "main" | "existing-church" | "create-church";

export default function Onboarding() {
  const [view, setView] = useState<OnboardingView>("main");
  const [churchName, setChurchName] = useState("");
  const [loading, setLoading] = useState(false);
  const { signOut, refreshVolunteerProfile } = useAuth();
        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              ...
              para adicionar seu e-mail na lista de voluntários.
            </p>
            <p className="text-muted-foreground">
              Após o administrador vincular seu e-mail, faça logout e login novamente 
